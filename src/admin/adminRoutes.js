...
router.post("/products/ai/generate-info",    h(req => svc.generateProductInfo(req.body.productName, req.body.rawInfo)));
router.put("/products/:id/info",             h(req => svc.updateProductInfo(req.params.id, req.body)));
